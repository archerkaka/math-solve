...
{
    public partial class FrmPrimThemDinh : Form
    {
        private int x, y;

        #region constructor
        public FrmPrimThemDinh()
        {
            InitializeComponent();
            x = -1;
            y = -1;
        ...
        public FrmPrimThemDinh(int _x, int _y)
        {
            InitializeComponent();
            x = _x;
            y = _y;
        ...
        private void ThemDinh()
        {
            if (Check())
            {
                ...
                int count = Data.Data.graph_Prim.dsDinh.Count;
                if (count == 0) dinh.ID = 1; else dinh.ID = Data.Data.graph_Prim.dsDinh[count - 1].ID + 1;
                Data.Data.graph_Prim.AddDinh(dinh);
        ...
        #region LoadForm
        private void FrmPrimThemDinh_Load(object sender, EventArgs e)
        {
