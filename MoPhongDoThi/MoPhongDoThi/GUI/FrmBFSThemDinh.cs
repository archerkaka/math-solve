...
{
    public partial class FrmBFSThemDinh : Form
    {
        private int x, y;

        #region constructor
        public FrmBFSThemDinh()
        {
            InitializeComponent();
            x = -1;
            y = -1;
        ...
        public FrmBFSThemDinh(int _x, int _y)
        {
            InitializeComponent();
            x = _x;
            y = _y;
        ...
        private void ThemDinh()
        {
            if (Check())
            {
                ...
                int count = Data.Data.graph_BFS.dsDinh.Count;
                if (count == 0) dinh.ID = 1; else dinh.ID = Data.Data.graph_BFS.dsDinh[count - 1].ID + 1;
                Data.Data.graph_BFS.AddDinh(dinh);
        ...
        #region LoadForm
        private void FrmBFSThemDinh_Load(object sender, EventArgs e)
        {
