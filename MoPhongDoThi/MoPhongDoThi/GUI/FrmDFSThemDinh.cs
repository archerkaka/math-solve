...
{
    public partial class FrmDFSThemDinh : Form
    {
        private int x, y;

        #region constructor
        public FrmDFSThemDinh()
        {
            InitializeComponent();
            x = -1;
            y = -1;
        ...
        public FrmDFSThemDinh(int _x, int _y)
        {
            InitializeComponent();
            x = _x;
            y = _y;
        ...
        private void ThemDinh()
        {
            if (Check())
            {
                ...
                int count = Data.Data.graph_DFS.dsDinh.Count;
                if (count == 0) dinh.ID = 1; else dinh.ID = Data.Data.graph_DFS.dsDinh[count - 1].ID + 1;
                Data.Data.graph_DFS.AddDinh(dinh);
        ...
        #region LoadForm
        private void FrmDFSThemDinh_Load(object sender, EventArgs e)
        {
