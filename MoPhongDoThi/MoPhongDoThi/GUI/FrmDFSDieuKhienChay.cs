...
{
    public partial class FrmDFSDieuKhienChay : Form
    {
        private List<DoThi> listDoThi = new List<DoThi>();
        private int index = 0;

        #region constructor
        public FrmDFSDieuKhienChay()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            ///  cbx Xuat Phat
            cbxDinhXuatPhat.DataSource = Data.Data.graph_DFS.dsDinh.ToList();
            cbxDinhXuatPhat.DisplayMember = "Ten";
            cbxDinhXuatPhat.ValueMember = "ID";

            // cbx ket thuc
            cbxDinhKetThuc.DataSource = Data.Data.graph_DFS.dsDinh.ToList();
        ...
        private void FrmDFSDieuKhienChay_Load(object sender, EventArgs e)
        {
            LoadInitControl();
